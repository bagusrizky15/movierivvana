package com.example.movierivvana.adapter;
...
import com.example.movierivvana.activity.DetailActivity;
...
public class RecyclerMoviesAdapter extends RecyclerView.Adapter<RecyclerMoviesAdapter.MyViewHolder> {
    ...
    public void onBindViewHolder(@NonNull RecyclerMoviesAdapter.MyViewHolder holder, int position) {
        ...
        holder.tvDeskription.setText(resultList.get(position).getOverview());
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        ImageView ivPoster;
        TextView tvTitle,tvDeskription;
        ...
        public MyViewHolder(@NonNull View itemView) {
            ...
            tvDeskription = itemView.findViewById(R.id.tvDeskripsi);
